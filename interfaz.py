...
def analizar_sintactico():
    ...
    errores = syn.analizar_sintactico(contenido_texto)
...
def analizar_lexico():
    contenido_texto = espacioTexto.get("1.0", tk.END)
    lex.resetear_numero_linea()
    numero_linea_inicial = lex.obtener_numero_linea()
    result = lex.analyze_lexical_string(contenido_texto, numero_linea_inicial)
