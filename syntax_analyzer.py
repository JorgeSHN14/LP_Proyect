...
def p_print(p):
    '''print : FMT_LIBRARY DOT PRINTLN LPAREN data RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA data RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA data RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA data COMMA RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA IDENTIFIER RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA IDENTIFIER COMMA RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA FLOAT RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA FLOAT COMMA RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA INTEGER RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA INTEGER COMMA RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA BOOLEAN RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA BOOLEAN COMMA RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA IDENTIFIER COMMA FLOAT RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA IDENTIFIER COMMA FLOAT COMMA RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA IDENTIFIER COMMA INTEGER RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA IDENTIFIER COMMA INTEGER COMMA RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA IDENTIFIER COMMA BOOLEAN RPAREN
             | FMT_LIBRARY DOT PRINTF LPAREN FMT_FORMAT_STRING COMMA value COMMA IDENTIFIER COMMA BOOLEAN COMMA RPAREN
    '''
...
func printf_example(name string, age int) {
    fmt.Printf("Name: %s, Age: %d\n", name, age)
}
func main() {
    printf_example("John", 25)
    printf_example("Alice", 30.5)
    printf_example("Bob", 30, "Male")
}
'''
